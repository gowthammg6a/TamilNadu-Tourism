export default function WhatsAppButton() {
  const phone = '919999999999' // Replace with real WhatsApp number
  const message = encodeURIComponent('Hi! I\'m interested in planning a Tamil Nadu trip. Can you help me?')
